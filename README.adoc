...
** CUDA 12.8, Python 3.12, GCC 11, PyTorch 2.8
** Better compatibility (e.g. for SageAttention).

* link:cu130-megapak/README.adoc[`cu130-megapak`]
** CUDA 13.0, Python 3.13 (with GIL), GCC 15, No xFormers
