...
**__Using PyTorch 2.9.1 and CUDA 12.8__**

image::../docs/concept-v6-megapak.svg["Concept Design"]

image:https://github.com/YanWenKun/ComfyUI-Docker/actions/workflows/build-cu128-megapak-pt29.yml/badge.svg["GitHub Workflow Status",link="https://github.com/YanWenKun/ComfyUI-Docker/actions/workflows/build-cu128-megapak-pt29.yml"]

https://hub.docker.com/r/yanwk/comfyui-boot/tags?name=cu128-megapak-pt29[View on <Docker Hub>]
...
* Note the xFormers 
https://github.com/YanWenKun/ComfyUI-Docker/issues/128[compatibility issues]
on Blackwell GPUs were fixed in this version. Now xFormers is enabled by default.
