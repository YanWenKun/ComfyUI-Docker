...
https://hub.docker.com/r/yanwk/comfyui-boot/tags?name=cu124-cn[在 <Docker Hub> 上查看]
...
docker pull dhub.kubesre.xyz/yanwk/comfyui-boot:cu124-cn
...
podman pull dhub.kubesre.xyz/yanwk/comfyui-boot:cu124-cn
