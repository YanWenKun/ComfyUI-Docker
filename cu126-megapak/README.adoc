...
image:https://github.com/YanWenKun/ComfyUI-Docker/actions/workflows/build-cu126-megapak.yml/badge.svg["GitHub Workflow Status",link="https://github.com/YanWenKun/ComfyUI-Docker/actions/workflows/build-cu126-megapak.yml"]

https://hub.docker.com/r/yanwk/comfyui-boot/tags?name=cu126-megapak[View on <Docker Hub>]
